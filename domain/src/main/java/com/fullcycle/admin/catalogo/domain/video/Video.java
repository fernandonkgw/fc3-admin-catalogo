...
public class Video extends AggregateRoot<VideoID> {
    ...
    public Video updateVideoMedia(final AudioVideoMedia aVideo) {
        this.video = aVideo;
        this.updatedAt = InstantUtils.now();

        onAudioVideoMediaUpdated(aVideo);
        return this;
    }

    public Video updateTrailerMedia(final AudioVideoMedia aTrailer) {
        this.trailer = aTrailer;
        this.updatedAt = InstantUtils.now();

        onAudioVideoMediaUpdated(aTrailer);
    ...
    // pesquisar pattern Visitor para atualizar de forma mais inteligente
