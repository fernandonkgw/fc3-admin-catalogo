...
public final class Fixture {
    ...
    public static Integer year() {
        return FAKER.random().nextInt(2010, 2021);
    }
    ...
    public static String title() {
        return FAKER.options().option(
                ...
                "Nao cometa esses erros ao trabalhar com Microsservicos",
                "Tets de Mutacao. Voce nao testa seu software corretamente"
        );
    }
    ...
    public static final class Videos {
        ...
        public static AudioVideoMedia audioVideo(final VideoMediaType type) {
            ...
            return AudioVideoMedia.with(id, name, "/raw/".concat(name));
        }

        public static ImageMedia imageMedia(final VideoMediaType type) {
            final var id = IdUtils.uuid();
            final var name = type.name().toLowerCase() + "_" + id;
            return ImageMedia.with(id, name, "/raw/".concat(name));
        }
