...
public class UpdateVideoUseCaseTest extends UseCaseTest {
    ...
    void givenAValidCommand_whenCallsUpdateVideo_shouldReturnVideoId() {
        ...
        verify(videoGateway).update(captor.capture());
        ...
        Assertions.assertEquals(aVideo.getCreatedAt(), videoCaptor.getCreatedAt());
        Assertions.assertTrue(aVideo.getUpdatedAt().isBefore(videoCaptor.getUpdatedAt()));
    }
    ...
    @Test
    void givenANullLaunchedYear_whenCallsUpdateVideo_shouldReturnDomainException() {
        // given
        final var aVideo = Fixture.Videos.systemDesign();
    ...
    void givenAValidCommand_whenCallsUpdateVideoThrowsException_shouldCallClearResources() {
        ...
        final var expectedErrorMessage = "An error on update video was observed";
        final var expectedTitle = Fixture.title();
        final var expectedDescription = Fixture.Videos.description();
        final var expectedLaunchYear = Year.of(Fixture.year());
        final var expectedDuration = Fixture.duration();
