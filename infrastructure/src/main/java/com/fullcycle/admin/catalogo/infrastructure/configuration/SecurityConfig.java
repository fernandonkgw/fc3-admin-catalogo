...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity(securedEnabled = true, jsr250Enabled = true) // verificacao nos controllers
    ...
    public SecurityFilterChain securityFilterChain(final HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authorize -> {
                    authorize
                            .antMatchers("/cast-members*").hasAnyRole(ROLE_ADMIN, ROLE_CAST_MEMBERS)
