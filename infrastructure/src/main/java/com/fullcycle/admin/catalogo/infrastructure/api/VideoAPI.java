...
public interface VideoAPI {
    ...
    ResponseEntity<?> createPatial(@RequestBody CreateVideoRequest payload);

    @GetMapping(value = "{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    @Operation(summary = " Get a video by it's identifier")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Video retrieved sucessfully" ),
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Video updated sucessfully" ),
            @ApiResponse(responseCode = "404", description = "Video was not found"),
            @ApiResponse(responseCode = "422", description = "A validation error was thrown"),
            @ApiResponse(responseCode = "500", description = "An internal server error was thrown")
    })
    ...
    @Operation(summary = " Get a video media by it's identifier")
    @ApiResponses(value = {
    ...
    @Operation(summary = " Upload a video media by it's identifier")
    @ApiResponses(value = {
