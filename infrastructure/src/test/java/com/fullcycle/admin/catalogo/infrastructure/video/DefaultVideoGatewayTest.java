...
class DefaultVideoGatewayTest {
    ...
    @Test
    @Transactional
        // @IntegrationTest nao tem transactional vai fazer um get entao uma query a mais
    void givenAValidVideo_whenCallsCreate_shouldPersistIt() {
        ...
        final AudioVideoMedia expectedTrailer =
                AudioVideoMedia.with("123", "trailer", "/media/video");

        final ImageMedia expectedBanner =
                ImageMedia.with("123", "banner", "/media/image");

        final ImageMedia expectedThumb =
                ImageMedia.with("123", "thumb", "/media/image");

        final ImageMedia expectedThumbHalf = ImageMedia.with("123", "thumbHalf", "/media/image");
    ...
    void givenAValidVideo_whenCallsUpdate_shouldPersistIt() {
        ...
        // when
        final var actualVideo = videoGateway.update(Video.with(aVideo)
                .update(
                        expectedTitle,
                        expectedDescription,
                        expectedLaunchYear,
    ...
    @Test
    void givenAValidVideo_whenCallsDeleteById_shouldPersistIt() {
        // given
        final var aVideo = videoGateway.create(Video.newVideo(
                Fixture.title(),
                Fixture.Videos.description(),
    ...
    @Test
    void givenAnInvalidVideo_whenCallsDeleteById_shouldPersistIt() {
        // given
        videoGateway.create(
                Video.newVideo(
                        Fixture.title(),
    ...
    @Test
    void givenAnInvalidVideo_whenCallsFindById_shouldReturnEmpty() {
        // given
        videoGateway.create(
                Video.newVideo(
                        Fixture.title(),
    ...
    @CsvSource({
            ...
            "21.1,0,10,1,1,21.1 Implementação dos testes integrados do findAll",
    })
