...
public class CastMemberE2ETest implements MockDsl {
    ...
    @Test
    void asACatalogAdminIShouldBeAbleSeeATreatedErrorByToCreateANewCastMemberWithInvalidValues() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, castMemberRepository.count());
    ...
    @Test
    void asACatalogAdminIShouldBeAbleToSortThruAllMembersByNameDesc() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, castMemberRepository.count());
    ...
    @Test
    void asACatalogAdminIShouldBeAbleToSeeATreatedErrorByGettingANotFoundACastMember() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, castMemberRepository.count());
