...
public class CategoryAPITest {
    ...
    @Test
    void givenAInvalidId_whenCallsUpdateCategory_thenShouldReturnNotFoundException() throws Exception {
        // given
    ...
    @Test
    void givenAInvalidName_whenCallsUpdateCategory_thenShouldReturnNotFoundException() throws Exception {
        // given
        final var expectedId = "123";
        final String expectedName = null;
        final var expectedDescription = "A categoria mais assistida";
    ...
    @Test
    void givenAnInvalidId_whenCallsDeleteCategory_shouldBeOk() throws Exception {
        // given
        final var expectedId = "123";
