...
public class CreateCastMemberUseCaseIT {
    ...
    @Test
    public void givenAValidCommand_whenCallsCreateMember_shouldReturnIt() {
        // given
    ...
    @Test
    public void givenAnInvalidNullName_whenCallsCreateCastMember_shouldThrowsNotificationException() {
        // given
    ...
    @Test
    public void givenAnInvalidNullType_whenCallsCreateCastMember_shouldThrowsNotificationException() {
        // given
        final var expectedName = Fixture.name();
