...
public class UpdateCastMemberUseCaseIT {
    ...
    @Test
    public void givenAValidCommand_whenCallsUpdateMember_shouldReturnItsIdentifier() {
        // given
    ...
    @Test
    public void givenAnInvalidCommand_whenCallsUpdateMember_shouldReturnItsIdentifier() {
        // given
        final var aMember = CastMember.newMember("vin diesel", CastMemberType.DIRECTOR);
    ...
    @Test
    public void givenAnInvalidType_whenCallsUpdateMember_shouldReturnItsIdentifier() {
        // given
        final var aMember = CastMember.newMember("vin diesel", CastMemberType.DIRECTOR);
    ...
    @Test
    public void givenAnInvalidId_whenCallsUpdateMember_shouldThrowsNotFoundException() {
        // given
