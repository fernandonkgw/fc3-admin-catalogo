...
public class CategoryE2ETest implements MockDsl {
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToGetACategoryItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToUpdateACategoryItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToActivateACategoryItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToDeleteACategoryItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldNotSeeAnErrorByDeleteingANotFoundCategory() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, categoryRepository.count());
