...
public class GenreE2ETest implements MockDsl {
    ...
    public void asACatalogAdminIShouldBeAbleToNavigateThruAllGenres() throws Exception {
        ...
        listGenres(0, 1)
                ...
                .andExpect(jsonPath("$.items[0].name", equalTo("Acao")));
    ...
    public void asACatalogAdminIShouldBeAbleToSortAllGenresBynameDesc() throws Exception {
        ...
        listGenres(0, 3, "", "name", "desc")
                ...
                .andExpect(jsonPath("$.items[2].name", equalTo("Acao")));
    }

    @Test
    public void asACatalogAdminIShouldBeAbleToGetAGenreItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToUpdateAGenreItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
        ...
        final var actualId = givenAGenre("Aca", expectedIsActive, expectedCategories);
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToInactivateACategoryItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToActivateAGenreItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldBeAbleToDeleteAGenreItsIdentifier() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
    ...
    @Test
    public void asACatalogAdminIShouldNotSeeAnErrorByDeleteingANotFoundGenre() throws Exception {
        Assertions.assertTrue(MYSQL_CONTAINER.isRunning());
        Assertions.assertEquals(0, genreRepository.count());
