...
public class CastMemberAPITest {
    ...
    @MockBean
    private DefaultCreateCastMemberUseCase createCastMemberUseCase; // por causa do non-sealed nao permite mockar
    ...
    void givenAValidCommand_whenCallsCreateCastMember_shouldReturnItsIdentifier() throws Exception {
        ...
        // when
        final var aRequest = post("/cast-members")
    ...
    @Test
    void givenInvalidName_whenCallsCreateCastMember_shouldReturnNotification() throws Exception {
        // given
    ...
    void givenAValidId_whenCallsGetById_shouldReturnIt() throws Exception {
        ...
        // when
        final var aRequest = get("/cast-members/{id}", expectedId)
                .with(ApiTest.CAST_MEMBERS_JWT)
    ...
    void givenAnInvalidId_whenCallsGetByIdAndCastMemberDoesntExists_shouldReturnNotFound() throws Exception {
        ...
        // when
        final var aRequest = get("/cast-members/{id}", expectedId.getValue())
                .with(ApiTest.CAST_MEMBERS_JWT)
                .accept(MediaType.APPLICATION_JSON);
    ...
    void givenAValidCommand_whenCallsUpdateCastMember_shouldReturnItsIdentifier() throws Exception {
        ...
        // when
        final var aRequest = put("/cast-members/{id}", expectedId.getValue())
                .with(ApiTest.CAST_MEMBERS_JWT)
                .contentType(MediaType.APPLICATION_JSON)
                .content(mapper.writeValueAsString(aCommand));
    ...
    void givenAValidId_whenCallsDeleteById_shouldDeleteIt() throws Exception {
        ...
        // when
        final var aRequest = delete("/cast-members/{id}", expectedId)
        .with(ApiTest.CAST_MEMBERS_JWT);
    ...
    void givenValidParams_whenCallListCastMembers_shouldReturnIt() throws Exception {
        ...
        // when
        final var aRequest = get("/cast-members")
                .with(ApiTest.CAST_MEMBERS_JWT)
